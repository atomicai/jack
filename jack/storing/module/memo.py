...
import numpy as np
from jack.etc import Document, Label
from jack.finding.iface import finder
from jack.storing.iface import store
from jack.tooling.sql import LogicalFilterClause
from jack.tooling.tool import get_batches_from_generator, initialize_device_settings
from tqdm import tqdm

logger = logging.getLogger(__name__)


class MemoDocStore(store.DocStore):
    """
    ...
    def write_documents(
        ...
        :param documents: a list of Python dictionaries or a list of Document objects.
    ...
    def query_by_embedding(
        ...
        for doc, score in zip(document_to_search, scores):
            ...
            new_document = Document(id=doc.id, text=doc.text, meta=curr_meta, embedding=doc.embedding)
    ...
    def update_embeddings(
        ...
        documents = self._query(index=index, filters=filters, only_documents_without_embedding=not update_existing_embeddings)
