...
from jack.storing import store
from jack.storing.doc import Document
from jack.tooling import api, tool

logger = logging.getLogger(__name__)


class ElasticDocStore(store.BaseDocStore):
    ...
    def query_by_embedding(
        ...
        body = {
            "size": top_k,
            "query": api.elastic_query_api(self.similarity, query_emb, embedding_field=self.embedding_field),
        }
