...
import numpy as np
from jack.etc import Document, Label, MultiLabel
from jack.finding.iface import finder
from jack.tooling.pipe import eval_data_from_json, eval_data_from_jsonl, squad_json_to_jsonl
...
class DocStore(abc.ABC):
    ...
    def describe_documents(self, index=None):
        ...
        stats = {
            ...
            "chars_max": max(l) if len(l) > 0 else 0,
            "chars_min": min(l) if len(l) > 0 else 0,
...
class KeywordDocumentStore(DocStore):
    """
